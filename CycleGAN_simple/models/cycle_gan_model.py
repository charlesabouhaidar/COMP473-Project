...
class CycleGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--cycle_weight_inc', type=float, default=0., help='increase on lambda weight on cycle consistency loss')
        return parser
    ...
    def __init__(self, opt):
        ...
        self.lambda_increase = opt.cycle_weight_inc
    ...
    def backward_G(self):
        ...
        if lambda_idt > 0:
            ...
            self.loss_idt_A = self.criterionIdt(self.idt_A, self.real_B) * self.lambda_B * lambda_idt
            # G_B should be identity if real_A is fed: ||G_B(A) - A||
            self.idt_B = self.netG_B(self.real_A)
            self.loss_idt_B = self.criterionIdt(self.idt_B, self.real_A) * self.lambda_A * lambda_idt
        else:
            self.loss_idt_A = 0
            self.loss_idt_B = 0
